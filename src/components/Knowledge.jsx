  ...
  return (
    <div style={{ padding: '24px 16px 88px 16px', maxWidth: '600px', margin: '0 auto' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '24px', marginTop: '24px' }}>
        <h1 style={{ fontSize: '20px', fontWeight: '700', color: 'var(--text-slate)', marginBottom: '4px' }}>月知識</h1>
        <p style={{ fontSize: '12px', color: 'var(--text-slate-light)', letterSpacing: '0.05em' }}>探索女性生理週期與身體奧秘</p>
      </div>
      ...
      <div style={{
        ...
        <div>
          <h2 style={{ fontSize: '18px', fontWeight: '700', color: 'var(--text-slate)' }}>生理週期賀爾蒙變化</h2>
        </div>

        {/* Legend */}
        <div style={{ display: 'flex', gap: '16px', justifyContent: 'flex-start', fontSize: '11px', paddingLeft: '2px' }}>
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <div style={{ position: 'absolute', left: '10.07%', transform: 'translateX(-50%)', color: '#898BA1', whiteSpace: 'nowrap' }}>月經期</div>
            <div style={{ position: 'absolute', left: '31.77%', transform: 'translateX(-50%)', color: '#898BA1', whiteSpace: 'nowrap' }}>濾泡期</div>
            <div style={{ position: 'absolute', left: '48.26%', transform: 'translateX(-50%)', color: '#898BA1', whiteSpace: 'nowrap' }}>排卵</div>
            <div style={{ position: 'absolute', left: '73.44%', transform: 'translateX(-50%)', color: '#898BA1', whiteSpace: 'nowrap' }}>黃體期</div>
          </div>
          ...
          {/* X-axis Labels */}
          <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '9px', color: 'var(--text-slate-muted)', fontWeight: '600', padding: '0 4px' }}>
            <span>第 1 天</span>
            <span>第 7 天</span>
            <span>第 14 天</span>
            <span>第 21 天</span>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <span style={{ fontSize: '13px', fontWeight: '700', color: 'var(--text-slate)' }}>拉動滑桿切換天數</span>
            <span style={{ fontSize: '13px', fontWeight: '700', color: 'var(--text-slate)', backgroundColor: 'rgba(91, 99, 122, 0.08)', padding: '2px 8px', borderRadius: '8px' }}>
        ...
        <div style={{
          ...
          <div>
            <span style={{ fontSize: '10px', fontWeight: '700', color: 'var(--text-slate-light)', letterSpacing: '0.05em', display: 'block', marginBottom: '2px' }}>生理階段</span>
            <h4 style={{ fontSize: '15px', fontWeight: '700', color: 'var(--text-slate)' }}>{selectedDayDetails.phaseName}</h4>
          </div>
          ...
          <div style={{ display: 'flex', gap: '12px', fontSize: '12px' }}>
            <div style={{ flex: 1, padding: '8px 10px', background: 'rgba(91, 99, 122, 0.08)', borderRadius: '12px', border: '1px solid var(--panel-border)' }}>
              <span style={{ display: 'block', fontSize: '9px', fontWeight: '700', color: 'var(--text-slate-light)', marginBottom: '2px' }}>雌激素</span>
              <span style={{ color: '#DBB57F', fontWeight: '700' }}>{selectedDayDetails.estrogen}</span>
            </div>
            <div style={{ flex: 1, padding: '8px 10px', background: 'rgba(91, 99, 122, 0.08)', borderRadius: '12px', border: '1px solid var(--panel-border)' }}>
              <span style={{ display: 'block', fontSize: '9px', fontWeight: '700', color: 'var(--text-slate-light)', marginBottom: '2px' }}>黃體素</span>
              <span style={{ color: '#898BA1', fontWeight: '700' }}>{selectedDayDetails.progesterone}</span>
            </div>
          </div>

          <div>
            <span style={{ fontSize: '10px', fontWeight: '700', color: 'var(--text-slate-light)', letterSpacing: '0.05em', display: 'block', marginBottom: '6px' }}>常見症狀</span>
          ...
          <div style={{ borderTop: '1px solid rgba(91, 99, 122, 0.06)', paddingTop: '10px' }}>
            <span style={{ fontSize: '10px', fontWeight: '700', color: 'var(--text-slate-light)', letterSpacing: '0.05em', display: 'block', marginBottom: '4px' }}>保養建議</span>
            <p style={{ fontSize: '12px', color: 'var(--text-slate)', lineHeight: '1.5', margin: 0 }}>
      ...
      <div style={{ marginBottom: '24px' }}>
        <h3 style={{ fontSize: '14px', fontWeight: '700', color: 'var(--text-slate)', marginBottom: '12px', paddingLeft: '4px' }}>
          四大生理階段指南
        </h3>
          ...
          {phaseCards.map(card => {
            ...
            return (
              ...
              >
                ...
                >
                  <div>
                    <h4 style={{ fontSize: '14px', fontWeight: '700', color: 'var(--text-slate)' }}>{card.title}</h4>
                  </div>
                  <div style={{
